...
func (d UserDAO) Insert(user model.User) error {
	if _, err := d.DB.Exec(`INSERT INTO "user" (id, name, hash, algorithmID) VALUES (gen_random_uuid(), $1, $2::bytea, $3);`, user.Name, user.PasswordHash, user.HashAlgorithm); err != nil {
